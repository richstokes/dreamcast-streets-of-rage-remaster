...
void SpriteProbe::beginObject(uint16_t slot,uint8_t type,uint32_t mapping,bool flip,int16_t x,int16_t y,uint16_t tileBase,uint32_t sat){
    pending_=ProbedObject{mapping&0xFFFFFF,slot,tileBase,x,y,type,0,0,flip};
