...
void platform_audio_submit(const int16_t *samples,unsigned frames){
...
void platform_audio_shutdown(){if(stream!=SND_STREAM_INVALID){snd_stream_destroy(stream);snd_stream_shutdown();stream=SND_STREAM_INVALID;}}
