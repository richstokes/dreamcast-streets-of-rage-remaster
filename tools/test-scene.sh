...
render="$root/src/render/vdp_scene.cpp $root/src/render/sprite_probe.cpp $root/src/render/art_catalog.cpp $root/src/render/scene_light.cpp $root/src/render/scene_particles.cpp"
