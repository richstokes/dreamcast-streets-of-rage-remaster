...
clang++ $flags "$root/tests/scene_test.cpp" $render $vdp -o "$root/build/tests/scene-test"
clang++ $flags "$root/tests/enhanced_scene_test.cpp" $render $vdp -o "$root/build/tests/enhanced-scene-test"
