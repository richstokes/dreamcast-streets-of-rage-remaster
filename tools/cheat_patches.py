...
With the cheats off, the original values and emulated instruction charges are
untouched.
"""
...
def patch_generated(text):
    """Returns (patched text, number of hooks placed): adjust_player_health lives
    in one generated partition."""
